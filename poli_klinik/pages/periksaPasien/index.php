...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-right text-bold">Daftar Periksa Pasien</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover table-bordered text-nowrap">
                            ...
                            <?php 
                                $no = 1;
                                $jumlahBelumDiperiksa = 0; // Penghitung pasien yang belum diperiksa
                                ...
                                while ($data = mysqli_fetch_assoc($result)) {
                                    if ($data['status_periksa'] == 0) {
                                        $jumlahBelumDiperiksa++; // Tambahkan 1 untuk pasien yang belum diperiksa
                                    }
                                ?>
                                <tr>
            ...
            <div class="mt-3">
                <h5>Jumlah Pasien Belum Diperiksa: <?php echo $jumlahBelumDiperiksa; ?></h5>
            </div>
        </div>
        <!-- /.row -->
    </div><!-- /.container-fluid -->
