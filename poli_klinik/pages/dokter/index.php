...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-right text-bold">Manajemen Dokter</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-bold ">Data Dokter</h3>

                        <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-success float-right" data-toggle="modal"
                                data-target="#addModal"><i class="fas fa-plus mr-1"></i>
                                Tambah
                            </button>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type='button' class='btn btn-sm  edit-btn mr-1 text-white' style = "background-color: #007BFF"
                                            data-toggle="modal"
                                            data-target="#editModal<?php echo $data['id'] ?>"><i class="fas fa-pencil-alt mr-1 "></i>Edit</button>
                                        <button type='button' class='btn btn-sm btn-danger edit-btn' data-toggle="modal"
                                            data-target="#hapusModal<?php echo $data['id'] ?>"><i class="fas fa-trash mr-1"></i> Hapus</button>
                                    </td>
