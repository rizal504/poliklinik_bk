...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-right text-bold">Manajemen Poli</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type='button' class='btn btn-sm edit-btn text-white' style = "background-color: #007BFF"
                                            data-toggle="modal"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="pages/poli/updatePoli.php" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="keterangan" class="text-center d-block">keterangan</label>
