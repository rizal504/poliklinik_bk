<aside class="main-sidebar elevation-4" style="background-color: white">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="assets/dist/img/pasien.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item menu-open" >
                    ...
                    <ul class="nav nav-treeview" >
                        <li class="nav-item">
                            <a href="dashboard_admin.php" class="nav-link">
                                ...
                                <p>Dashboard <span class="right badge text-white" style="background-color: #77E4C8">Admin</span></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="dokter.php" class="nav-link">
                                <i class="fas fa-solid fa-user-nurse nav-icon"></i>
                                <p>Dokter <span class="right badge text-white" style="background-color: #77E4C8">Admin</span></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="poli.php" class="nav-link">
                                <i class="fas fa-solid fa-hospital nav-icon"></i>
                                <p>Poli <span class="right badge text-white" style="background-color: #77E4C8">Admin</span></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="obat.php" class="nav-link">
                                <i class="fas fa-solid fa-tablets nav-icon"></i>
                                <p>Obat <span class="right badge text-white" style="background-color: #77E4C8">Admin</span></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="pasien.php" class="nav-link">
                                <i class="fas fa-solid fa-user nav-icon"></i>
                                <p>Pasien <span class="right badge text-white" style="background-color: #77E4C8">Admin</span></p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="profile_pasien.php" class="nav-link">
                                <i class="fas fa-solid fa-user nav-icon"></i>
                                <p>Profile<span class="right badge badge-info">Pasien</span></p>
                            </a>
                        </li>
                    </ul>
                    <?php } ?>
