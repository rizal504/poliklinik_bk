    ...
    <div class="login-container">
        ...
        <div class="right-container">
            <div class="login-form">
                ...
                <p class="login-box-msg text-center">Silahkan login sebagai <b class="" style="color: #3A96E6">Dokter</b> </p>
                <br><br>
            ...
            <div class="text-center mt-3">Login Sebagai <a href="loginAdmin.php"><span
